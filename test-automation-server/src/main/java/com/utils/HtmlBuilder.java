...
public class HtmlBuilder {
	...
	public static String htmlBody(Map<String, ArrayList<String>> resFromDb) {

		String htmlFileBody = "";
		htmlFileBody += "\n" + "<body>";
		
		int htmlTableCount = 1;
		for (String title : resFromDb.keySet()) {
			...
			if (!title.equalsIgnoreCase("headers")) {
				...
				ArrayList<String> headersList = resFromDb.get("headers");
				...
				// Build rows
				ArrayList<String> keyBindedData = resFromDb.get(title);
